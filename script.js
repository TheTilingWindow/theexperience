                    ...
                    case 'jo':
                        ...
                        case 'jp':
                            ...
                            case 'kw':
                                ...
                                flag.src = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Flag_of_Kuwait.svg/500px-Flag_of_Kuwait.svg.png"
                                title.innerHTML = "This is Kuwait!"
                                parent.style.backgroundImage = 'url("https://content.r9cdn.net/rimg/dimg/97/e9/bbcce1e6-ctry-133-16cd86277ef.jpg")'
                                title.style.color = "#000000"
    }         
}

function hidemenu() {
    document.getElementById('gflag').hidden = true;
}
